...
export default function Invite() {
    return (
        <div id="vem-ser-ds" className="font-bricolage top-100% text-white flex flex-col items-center">
            <h1 className="mt-10 font-bold text-[3rem]">
                Agora é com você, vem ser <span className="text-[#8E7BFF]">DS</span>
            </h1>
            <p className="font-light text-[1.5rem] text-center">
